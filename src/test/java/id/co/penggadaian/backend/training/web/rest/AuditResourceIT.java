...
import id.co.penggadaian.backend.training.repository.PersistenceAuditEventRepository;

import id.co.penggadaian.backend.training.service.AuditEventService;
