...
import id.co.penggadaian.backend.training.config.audit.AuditEventConverter;
import id.co.penggadaian.backend.training.domain.PersistentAuditEvent;
...
import static id.co.penggadaian.backend.training.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
