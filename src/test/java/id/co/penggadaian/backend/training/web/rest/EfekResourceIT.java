...
import id.co.penggadaian.backend.training.repository.EfekRepository;
...
public class EfekResourceIT {
    ...
    public void getAllEfeks() throws Exception {
        ...
        restEfekMockMvc.perform(get("/api/efeks?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].kodeEfek").value(hasItem(DEFAULT_KODE_EFEK)))
            .andExpect(jsonPath("$.[*].namaEfek").value(hasItem(DEFAULT_NAMA_EFEK)))
    ...
    public void getEfek() throws Exception {
        ...
        restEfekMockMvc.perform(get("/api/efeks/{id}", efek.getId()))
            ...
            .andExpect(jsonPath("$.kodeEfek").value(DEFAULT_KODE_EFEK))
            .andExpect(jsonPath("$.namaEfek").value(DEFAULT_NAMA_EFEK))
