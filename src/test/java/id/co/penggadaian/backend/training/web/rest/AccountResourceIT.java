...
import id.co.penggadaian.backend.training.config.Constants;
import id.co.penggadaian.backend.training.domain.Authority;
import id.co.penggadaian.backend.training.domain.User;
import id.co.penggadaian.backend.training.repository.AuthorityRepository;
import id.co.penggadaian.backend.training.repository.UserRepository;
import id.co.penggadaian.backend.training.security.AuthoritiesConstants;
import id.co.penggadaian.backend.training.service.MailService;
import id.co.penggadaian.backend.training.service.UserService;
import id.co.penggadaian.backend.training.service.dto.PasswordChangeDTO;
import id.co.penggadaian.backend.training.service.dto.UserDTO;
import id.co.penggadaian.backend.training.web.rest.errors.ExceptionTranslator;
import id.co.penggadaian.backend.training.web.rest.vm.KeyAndPasswordVM;
import id.co.penggadaian.backend.training.web.rest.vm.ManagedUserVM;
