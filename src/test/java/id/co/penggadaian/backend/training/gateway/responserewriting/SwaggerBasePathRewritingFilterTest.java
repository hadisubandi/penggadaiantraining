package id.co.penggadaian.backend.training.gateway.responserewriting;
...
import static id.co.penggadaian.backend.training.gateway.responserewriting.SwaggerBasePathRewritingFilter.gzipData;
