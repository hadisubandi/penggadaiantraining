...
export const EfekMySuffixDetail = (props: IEfekMySuffixDetailProps) => {
  useEffect(() => {
  ...
  return (
    <Row>
      <Col md="8">
        ...
        <Button tag={Link} to="/efek-my-suffix" replace color="info">
          <FontAwesomeIcon icon="arrow-left" /> <span className="d-none d-md-inline">Back</span>
        </Button>
        &nbsp;
        <Button tag={Link} to={`/efek-my-suffix/${efekEntity.id}/edit`} replace color="primary">
...
export default connect(mapStateToProps, mapDispatchToProps)(EfekMySuffixDetail);
