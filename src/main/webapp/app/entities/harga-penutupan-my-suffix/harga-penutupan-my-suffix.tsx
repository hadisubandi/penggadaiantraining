...
export const HargaPenutupanMySuffix = (props: IHargaPenutupanMySuffixProps) => {
  ...
  const { hargaPenutupanList, match, totalItems } = props;
  return (
    <div>
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('tanggal')}>
                  Tanggal <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('harga')}>
                ...
                <tr key={`entity-${i}`}>
                  ...
                  <td className="text-right">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`${match.url}/${hargaPenutupan.id}/edit?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="primary"
                        size="sm"
                      >
                      ...
                      <Button
                        tag={Link}
                        to={`${match.url}/${hargaPenutupan.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="danger"
                        size="sm"
                      >
      ...
      <div className={hargaPenutupanList && hargaPenutupanList.length > 0 ? '' : 'd-none'}>
...
export default connect(mapStateToProps, mapDispatchToProps)(HargaPenutupanMySuffix);
