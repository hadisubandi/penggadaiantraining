...
export const HargaPenutupanMySuffixDetail = (props: IHargaPenutupanMySuffixDetailProps) => {
  useEffect(() => {
  ...
  return (
    <Row>
      <Col md="8">
        ...
        <Button tag={Link} to="/harga-penutupan-my-suffix" replace color="info">
          <FontAwesomeIcon icon="arrow-left" /> <span className="d-none d-md-inline">Back</span>
        </Button>
        &nbsp;
        <Button tag={Link} to={`/harga-penutupan-my-suffix/${hargaPenutupanEntity.id}/edit`} replace color="primary">
...
export default connect(mapStateToProps, mapDispatchToProps)(HargaPenutupanMySuffixDetail);
